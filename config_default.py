...
class Config:
    def __init__(
            ...
            save_dir=None, icon: str=None, fonts: dict[str, str] | None = None, **kwargs
            ):
        ...
        self.min_resolution: Vector2 = min_resolution if min_resolution is not None else Vector2(550,450)
