...
class Config:
    def __init__(
            ...
            save_dir=None, icon: str=None, **kwargs
            ):
        ...
        self.resolution = resolution if resolution is not None else Vector2(800, 550)
        self.min_resolution = min_resolution if min_resolution is not None else Vector2(550,450)
