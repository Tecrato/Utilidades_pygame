...
class Desicion(Base_win):
    def __init__(self, pos, font_mononoki, title, texto, size = (400,200), func=None):
        ...
        self.btn_cancelar = uti_pag.Button('Cancelar',16,self.font,(0,0), 15, 'bottomright','black','purple', color_rect_active='cyan', border_width=-1, border_radius=0, func=self.func_cancelar)
        self.add(self.btn_cancelar, f'{self.btn_aceptar.left-20},{self.size[1]-10}', clicking=True)
