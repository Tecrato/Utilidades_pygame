...
class Particles:
    def __init__(
            ...
            vel_dispersion = 0, angle_dispersion = 0, dispersion_radio = 0, max_particles = 100, time_between_spawns = .1,
        ...
        self.dispersion_radio = dispersion_radio
    ...
    def update(self, dt = 1) -> None:
        ...
        for i,part in sorted(enumerate(self.particles),reverse=True):
            ...
            if self.gravity > 0:
                ...
                part.vel = Hipotenuza((0,0),v)
                part.direccion = v.normalize()
            if Hipotenuza(part.pos, self.spawn_pos) > self.max_distance:
                self.particles.pop(i)
    ...
    def __add_particle(self):
        ...
        radio = self.radio + self.dispersion_radio * random.uniform(-1, 1)
        ...
        self.particles.append(Particle(self.spawn_pos, radio, self.color, vel, direccion))
